...
class VideoView(QWidget):
    ...
    def __init__(self, parent, **kwargs):
        ...
        self.borders_btn.setText('Добавить границы')
        self.toolbar_hbox.addWidget(self.borders_btn)
        self.borders_clear_btn = ToolbarButton(self)
        self.borders_clear_btn.setText('Очистить границы')
        self.toolbar_hbox.addWidget(self.borders_clear_btn)
